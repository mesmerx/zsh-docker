# Generated by Powerlevel10k configuration wizard on 2020-04-03 at 16:19 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='❯ $(echo $(($( history |tail -n 1 | cut -d" " -f2)+1)))'
  ...
  #
  typeset -g POWERLEVEL9K_PYENV_CONTENT_EXPANSION='${P9K_CONTENT}${${P9K_PYENV_PYTHON_VERSION:#$P9K_CONTENT}:+ $P9K_PYENV_PYTHON_VERSION} $(python --version |cut -f2 -d" ")'
  ...
  # Transient prompt works similarly to ahe builtin transient_rprompt option. It trims down prompt
